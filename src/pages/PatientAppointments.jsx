  ...
  return (
    <div className="dashboard-container">
      ...
      <button
        ...
        style={{ background: "var(--secondary)", marginBottom: "16px" }}
      >
            ...
            <div className="grid-cards">
              {appointments.map((appt) => (
                <div key={appt._id} className="appointment-card">
                  ...
                  >
                    {appt.status === "Accepted" &&
                      (!appt.feeStatus || appt.feeStatus === "Pending") &&
                      appt.feeAmount > 0 && (
                        <button
        ...
        >
          ...
          >
            ...
            <div style={{ marginBottom: "12px" }}>
              ...
              <input
                type="checkbox"
                checked={isEmergencyReq}
                onChange={(e) => setIsEmergencyReq(e.target.checked)}
            ...
            <div style={{ display: "flex", gap: "12px", marginTop: "16px" }}>
              ...
              <button
                ...
                className="btn-primary"
                style={{ flex: 1, background: "#cbd5e1", color: "#1e293b" }}
              >
                Cancel
              </button>
            </div>
